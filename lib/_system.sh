...
system_node_install() {
  ...
  sleep 2
  sudo -u postgres psql -c "ALTER USER bchat PASSWORD '15995123';"
  sudo -u postgres psql -c "CREATE DATABASE bchat;"
  exit
EOF
...
system_set_ufw() {
  ...
  sudo su - root <<EOF
  ufw allow 80/tcp && ufw allow 22/tcp && ufw allow 443/tcp && ufw allow 8080/tcp && ufw allow 8081/tcp && ufw allow 3000/tcp && ufw allow 9005/tcp && ufw allow 3003/tcp && ufw allow 6379/tcp && ufw allow 5432/tcp && ufw allow 443/tcp && ufw allow 4001/tcp  && ufw allow 4002/tcp  && ufw allow 3001/tcp  && ufw allow 3002/tcp
EOF
